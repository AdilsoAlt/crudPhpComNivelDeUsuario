        ...
        <div class="container-fluid">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              <?php if ($_SESSION["permissao"] == "1")echo '<li class="cadastrarFuncionario"><a href="cadastraFuncionario">Cadastra Funcionário</a></li>'?>
              <li  class="visualizarFuncionario"><a href="exibeFuncionarios">Exibe Funcionário</a></li>
              <?php if ($_SESSION["permissao"] == "1") echo '<li class="cadastrarDepartamento"><a href="cadastraDepartamento">Cadastra Departamento</a></li>'?>
